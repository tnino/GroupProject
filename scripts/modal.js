...
|| weather.condition === 'ragged thunderstorm' || weather.condition === 'thunderstrom with drizzle' || weather.condition === 'thunderstrom with heavy drizzle') {
  ...
  There's a thunderstorm! Pick another activity.`;
    ...
    //hot
      ...
      document.getElementById("modal-body-run").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. The wind direction is 
...
//mid-temperature
    if (weather.temperature <= 55) {
        document.getElementById("modal-body-swim").textContent = `In ${weather.city} there is 
        ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
        The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
...
//mid-temperature
    if (weather.temperature <= 40) {
      document.getElementById("modal-body-climb").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
...
//atmosphere
  ...
  $("#myModal4").on("shown.bs.modal", function() {
    ...
    if (weather.temperature <= 0) {
        document.getElementById("modal-body-board").textContent = `In ${weather.city} there is 
        ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. The wind direction is 
...
//rain
    } if ( weather.condition === 'moderate rain' || weather.condition === 'heavy intensity rain'
    || weather.condition === 'very heavy rain'|| weather.condition === 'extreme rain' || weather.condition === 'freezing rain' 
    || weather.condition === 'light intensity shower rain' || weather.condition === 'shower rain' || weather.condition === 'heavy intensity shower rain' 
    || weather.condition === 'ragged shower rain') {
      document.getElementById("modal-body-run").textContent = `In ${weather.city} there is 
...
//heavy snow
} if (weather.condition === 'heavy snow') {
      document.getElementById("modal-body-run").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing outside! Pick another activity.`;
...
//sleet
      ...
      //rain and snow
  } if (weather.condition === 'rain and snow') {
      document.getElementById("modal-body-run").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing and raining outside! Pick another activity.`;
...
//below freezing
    if (weather.temperature <= 30) {
      document.getElementById("modal-body-kayak").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
...
//sleet
  ...
  $("#myModal6").on("shown.bs.modal", function() {
   ...
   //mid-temperature 
    if (weather.temperature <= 40) {
      document.getElementById("modal-body-cross").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
    ...
    || weather.condition === 'ragged shower rain') {
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's raining outside! Pick another activity or work out inside.`;
...
${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
There's a thunderstorm! Pick another activity or workout inside.`;
...
//snow
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing outside! Pick another activity or workout inside.`;
...
//sleet
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's sleeting outside! Pick another activity or workout inside.`;

     //rain and snow 
  } if (weather.condition === 'light rain and snow' || weather.condition === 'rain and snow' || weather.condition === 'shower sleet') {
      document.getElementById("modal-body-run").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing and raining outside! Pick another activity or workout inside.`;
...
//atmosphere
  ...
  $("#myModal7").on("shown.bs.modal", function() {
    ...
    //mid-temperature
    if (weather.temperature <= 40) {
      document.getElementById("modal-body-skate").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
...
//mid-temperature
    if (weather.temperature <= 40) {
      document.getElementById("modal-body-yoga").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
...
//rain
    ...
    || weather.condition === 'ragged shower rain') {
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's raining outside! Pick another activity or practice yoga inside.`;
...
${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
There's a thunderstorm! Pick another activity or practice yoga inside.`;
...
//snow
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing outside! Pick another activity or practice yoga inside.`;
...
//sleet
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's sleeting outside! Pick another activity or practice yoga inside.`;
...
//rain and snow
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing and raining outside! Pick another activity or practice yoga inside.`;
...
//mid-temperture
    if (weather.temperature <= 40) {
      document.getElementById("modal-body-box").textContent = `In ${weather.city} there is 
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
...
//rain
    ...
    || weather.condition === 'ragged shower rain') {
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's raining outside! Pick another activity or box inside.`;
...
${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
There's a thunderstorm! Pick another activity or box inside.`;
...
//snow
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing outside! Pick another activity or box inside.`;
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's sleeting outside! Pick another activity or box inside.`;
...
//rain and snow
      ...
      ${weather.condition} with a temperature of ${weather.temperature} degrees fahrenheit. 
      The wind direction is ${weather.windDirection} with a speed of ${weather.windSpeed}. 
      It's snowing and raining outside! Pick another activity or box inside.`;
